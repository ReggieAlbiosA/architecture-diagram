...
} from "@/components/header/client/theme-toggle";
...
import {
  navigationConfig,
  type NavigationItem,
} from "./diagram/_config/navigation.config";
        ...
        >
          <HeaderMobileMenu>
            <Header
              sticky
              topOffset={0}
              className="flex-shrink-0 bg-white flex justify-between items-center h-14 px-4 lg:px-10 dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800"
            >
              {/* Brand */}
              <HeaderBrand>
              ...
              <div className="hidden lg:flex gap-x-2">
                <HeaderNavigation>
                  <HeaderNavItem href="/diagram/git/architecture/local">
                    Diagrams
                  </HeaderNavItem>
                </HeaderNavigation>
